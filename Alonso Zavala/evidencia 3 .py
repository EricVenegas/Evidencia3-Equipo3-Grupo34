    ...
    try:
        with sqlite3.connect("34.db", detect_types = sqlite3.PARSE_DECLTYPES | sqlite3.PARSE_COLNAMES) as conn:
            ...
            for folio, nombre, horario, fecha in registros:
                ...
                print(f'Folio: {folio}, Nombre: {nombre}, Horario: {horario}, Fecha: {fecha_formateada}')
    except Error as e:
        print (e)
    except Exception:
        print(f"Se produjo el siguiente error: {sys.exc_info()[0]}")
...
def reporte_a_Excel ():
    while True:
        fecha_reporte = input("¿De que fecha quieres sacar el reporte? (Escribe SALIR para regresar al menú): ")
...
def Registrar_Cliente():
    global n
    while True:
        Usuario=input("Ingresa el nombre de usuario.(Escribe SALIR si quieres regresar al menú principal): ")
        n+=1
        if Usuario=='':
            break
        elif Usuario=='SALIR':
            ...
            try:
                ...
                print("Tu clave de cliente es la siguiente: ",n)
                return
            except Error as e:
                print (e)
            except:
    ...
    while True:
        ...
        try:
            ...
            if id_sala == '':
                ...
                Name = input("Cual era tu nombre de la sala?: ")
                Turno = input("Escribe tu horario: ")
                fecha_asignada = input("Ingresa la fecha por favor:(dia/mes/year) ")
